...
object TradeEvent {
  ...
  case class ScrapStockMapping(exchangeName: String) extends WebScrapingRequest


  // Data generator request
  trait DataGeneratorRequest extends TradeActivity
  case class GenerateStockData(exchangeName: String) extends DataGeneratorRequest
}
